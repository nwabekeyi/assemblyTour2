...
function Customer() {
  ...
  return (
    <div className="container px-4 py-12 md:py-16 mx-auto bg-gradient-to-b from-gray-50 to-white">
      {/* Header */}
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <button
          onClick={prevSlide}
          className="hidden sm:flex absolute left-0 z-10 p-3 transition-all duration-300 transform -translate-x-4 -translate-y-1/2 bg-white rounded-full shadow-lg top-1/2 hover:shadow-xl hover:scale-110 group"
        >
        ...
        <button
          onClick={nextSlide}
          className="hidden sm:flex absolute right-0 z-10 p-3 transition-all duration-300 transform translate-x-4 -translate-y-1/2 bg-white rounded-full shadow-lg top-1/2 hover:shadow-xl hover:scale-110 group"
        >
