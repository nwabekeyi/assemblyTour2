...
function LogInPage() {
	...
	return (
		<div className="relative h-[100vh] flex flex-col justify-center py-5 sm:px-6 lg:px-8">
			<motion.div
			...
			>
				<h2 className='text-3xl font-extrabold text-center text-emerald-400'>Sign into your account</h2>
			</motion.div>
