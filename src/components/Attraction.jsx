...
function Attraction() {
  const attractions = [
    {
      id: 1,
      title: "THE HOLY KAABA & TAWAF",
      description: "The spiritual heart of Islam where pilgrims perform the sacred ritual of Tawaf, circling the Kaaba in complete devotion and unity.",
      image: kabba,
      overlay: true
    },
    {
      ...
      description: "The Prophet's Mosque in Madinah with its iconic Green Dome and Rawdah Mubarak – a place described as a garden from the gardens of Paradise.",
      image: majid,
      overlay: true
    },
    {
      id: 3,
      title: "MOUNT ARAFAT",
      description: "The most sacred day of Hajj takes place here on the Day of Arafah, where pilgrims stand in supplication seeking Allah's mercy and forgiveness.",
      image: arafat,
      overlay: true
    }
  ];
      ...
      <div className='container px-4 mx-auto'>
        ...
        >
          ...
          <p className='text-lg leading-relaxed text-gray-600 md:text-xl'>
            Experience the most blessed and spiritually profound locations during your Umrah or Hajj journey in the holy cities of Makkah and Madinah.
          </p>
        </motion.div>
          ...
          {attractions.map((attraction) => (
            ...
            >
              ...
              <div className='absolute inset-0 flex flex-col justify-end p-6 text-white'>
                ...
                >
                  <h3 className='mb-3 font-serif text-2xl font-bold'>{attraction.title}</h3>
                  <p className='leading-relaxed text-gray-200'>{attraction.description}</p>
                </motion.div>
              </div>
            </motion.div>
          ))}
